...
class EvaluaionRunner:
    ...
    def evaluate_case(self, cases):
        for case in cases:
            ...
            if case_name in ["hdac2","mcr","nos1"]:
                continue
            ...
            for i, mol in tqdm(enumerate(reader)):
                ...
                print("Vinia dock score: ", vina_dock_score)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--sdf_path', type=str, default='/data/ligan_data/PDBBind-DUD_E_FLAPP_0.6')
    parser.add_argument('-n', '--num_process', type=int, default=20)
