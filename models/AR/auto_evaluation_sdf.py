...
class EvaluaionRunner:
    def __init__(self, args):
        self.exp_prefix="/data/AR_data/PCBA_sample_output/"
    ...
    def run(self):
        ...
        print(self.exp_prefix + self.exp_name + "/*")
        case_list.sort()
        
        # for x in case_list:
        #     dir_name=x.replace(".sdf","")
...
if __name__ == '__main__':
    ...
    parser.add_argument('--exp_name', type=str, default='PDBBind-DUD_E_FLAPP_0.9')
